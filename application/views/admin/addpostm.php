...
<?php include "inc/sidbar.php" ?>
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add Meal</h2>
                <div class="block">               
                 <form action="<?php echo base_url(); ?>Admin/add_meal" method="post" enctype="multipart/form-data">
                    <table class="form">
...
<script src="<?php echo base_url(); ?>resource/admin_resource/js/tiny-mce/tinymce.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>resource/admin_resource/js/init.js" type="text/javascript"></script>
